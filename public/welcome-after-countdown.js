// welcome-after-countdown.js — add welcome text after countdown section with the same section system
(function addWelcomeAfterCountdown(){
  ...
  style.textContent = `
    ...
    #aa-welcome-message:before,
    #aa-welcome-message:after{
    ...
    #aa-welcome-message .aa-welcome-frame{
    ...
    @media(max-width:720px){
      #aa-welcome-message{padding-top:72px!important;padding-bottom:72px!important;}
      #aa-welcome-message .inner{width:min(100% - 30px, 980px)!important;}
      #aa-welcome-message .aa-welcome-frame{padding:44px 0 42px!important;}
